...
#'
#' @format Un tableau de données de sept variables et 395 observations:
#' \describe{
...
#' \describe{
#'   \item{\code{gender}}{A **factor** with two levels: `"M"`, and `"W"`.}
...
#'   \item{\code{year_measure}}{Year of the measure.}
