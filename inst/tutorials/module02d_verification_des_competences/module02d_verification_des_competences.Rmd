...
Ce tutoriel a pour objectif d'évaluer l'acquisition des compétences de module 2.
...
Assignez la valeur `43` à la chaine de caractères `var1`. Terminez par appeler `var1`.
