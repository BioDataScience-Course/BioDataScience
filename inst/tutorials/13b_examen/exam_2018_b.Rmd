...
quiz(question("Quelle est la probabilité d'être en sous-poids ?",
              answer(sprintf("$%s$", 
                             round((sum(imc[ ,1])/sum(imc[1:3, ])), 2)), correct = TRUE),
              answer(sprintf("$%s$", 
                             round((sum(imc[ ,2])/sum(imc[1:3, ])), 2))),
              answer(sprintf("$%s$", 
     ...
     question("Quelle est la probabilité d'avoir une activité physique occasionnelle ou d'être en surpoids ?",
              answer(sprintf("$%s$", 
                             round((sum(imc[1, ]) + sum(imc[ ,3]) - imc[1,3]) / sum(imc[1:3, ]), 2)), 
                     correct = TRUE),
              answer(sprintf("$%s$", 
                             round((sum(imc[1, ]) + sum(imc[ ,3])) / sum(imc[1:3, ]), 2))),
              answer(sprintf("$%s$", 
