...
Vos objectifs dans ce learnR est découvrir les bases du language R 
...
Vous pouvez tout d'abord employer R comme un calculatice ( ce qui est bien réducteur de la puissance du language)

```{r calculatrice, echo= TRUE}
4 + 5
```

Additionnez  les nombres `15` et `23`
